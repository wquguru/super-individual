...
const testimonials: Testimonial[] = [
  {
    ...
    content: "通过1小时咨询，我找到了创业方向。WquGuru的建议既有战略高度，又务实可行。",
    rating: 5,
    emoji: "👨‍💻",
  },
  {
  ...
  },
  {
    ...
    content: "WquGuru在React和系统架构方面的指导让我茅塞顿开。他不仅教会了我技术，还教会了我如何思考问题。",
    rating: 5,
    emoji: "👨‍🔧",
  },
  {
    ...
    company: "AInnova",
    content: "WquGuru的建议帮助我的创业项目在三个月内完成了天使轮融资。他对技术和商业的理解令人印象深刻。",
    rating: 5,
    emoji: "👩‍🚀",
  },
  {
    ...
    role: "Tech Lead",
    company: "CloudMatrix",
    content: "作为技术团队负责人，我从WquGuru那里学到了很多关于团队管理和技术架构的宝贵经验。",
    rating: 5,
    emoji: "👨‍🏫",
  },
];
